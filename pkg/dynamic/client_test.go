...
func TestDelete(t *testing.T) {
	...
	for _, tc := range tcs {
		...
		_, _, err = cl.Resource(resource).Namespace(tc.namespace).Delete(context.TODO(), tc.name, tc.deleteOptions, tc.subresource...)
		if err != nil {
...
func TestDeleteCollection(t *testing.T) {
	...
	for _, tc := range tcs {
		...
		_, err = cl.Resource(resource).Namespace(tc.namespace).DeleteCollection(context.TODO(), metav1.DeleteOptions{}, metav1.ListOptions{})
		if err != nil {
...
func TestUpdate(t *testing.T) {
	...
	for _, tc := range tcs {
		...
		got, _, err := cl.Resource(resource).Namespace(tc.namespace).Update(context.TODO(), tc.obj, metav1.UpdateOptions{}, tc.subresource...)
		if err != nil {
...
func TestPatch(t *testing.T) {
	...
	for _, tc := range tcs {
		...
		got, _, err := cl.Resource(resource).Namespace(tc.namespace).Patch(context.TODO(), tc.name, types.StrategicMergePatchType, tc.patch, metav1.PatchOptions{}, tc.subresource...)
		if err != nil {
